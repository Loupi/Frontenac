...
namespace Frontenac.Blueprints.Impls.TG
{
    ...
    internal class TinkerEdge : TinkerElement, IEdge
    {
        ...
        public TinkerEdge(string id, IVertex outVertex, IVertex inVertex, string label, TinkerGraph tinkerGraph)
            : base(id, tinkerGraph)
        {
            if (id == null)
            ...
            _inVertex = inVertex;
            tinkerGraph.EdgeKeyIndex.AutoUpdate(StringFactory.Label, Label, null, this);
        }
