...
namespace Frontenac.Infrastructure.Indexing
{
    public class TransactionalIndexCollection : IIndexCollection
    {
        ...
        public readonly List<long> DeletedDocuments = new List<long>();
        readonly Dictionary<string, Tuple<long, string, string, object>> _setIndices
            = new Dictionary<string, Tuple<long, string, string, object>>();
        ...
        public long Set(long id, string indexName, string key, object value)
        {
            ...
            var setValue = new Tuple<long, string, string, object>(id, indexName, key, value);
