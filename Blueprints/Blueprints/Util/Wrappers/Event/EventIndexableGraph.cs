...
{
    /// <summary>
    ///     EventIndexableGraph is merely a proxy to index methods exposing eventInnerTinkerGraĥ methods in the "evented" way. Like the
    ///     eventInnerTinkerGraĥ it extends from, this graph implementations raise notifications to the listeners for the
