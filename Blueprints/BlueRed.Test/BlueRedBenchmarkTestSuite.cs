...
{
    public abstract class BlueRedBenchmarkTestSuite : TestSuite
    {
        private const int TotalRuns = 10;

        protected BlueRedBenchmarkTestSuite(GraphTest graphTest)
            : base("BlueRedBenchmarkTestSuite", graphTest)
        {
        }
        ...
        public void TestTinkerGraph()
        {
            ...
            PrintPerformance("TinkerGraph", 1, "TinkerGraĥ experiment average", (long) (totalTime/TotalRuns));
        }
    }
}